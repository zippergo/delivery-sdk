...
public class RecentDeliveryResponse {
  ...
  public RecentDeliveryResponse deliveryId(@javax.annotation.Nullable UUID deliveryId) {
  ...
  public RecentDeliveryResponse hubTrackingNumber(@javax.annotation.Nullable String hubTrackingNumber) {
  ...
  public RecentDeliveryResponse status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public RecentDeliveryResponse deliveryType(@javax.annotation.Nullable String deliveryType) {
  ...
  public RecentDeliveryResponse merchantName(@javax.annotation.Nullable String merchantName) {
  ...
  public RecentDeliveryResponse createdDate(@javax.annotation.Nullable OffsetDateTime createdDate) {
  ...
  public boolean equals(Object o) {
    ...
    RecentDeliveryResponse recentDeliveryResponse = (RecentDeliveryResponse) o;
    return Objects.equals(this.deliveryId, recentDeliveryResponse.deliveryId) &&
        Objects.equals(this.hubTrackingNumber, recentDeliveryResponse.hubTrackingNumber) &&
        Objects.equals(this.status, recentDeliveryResponse.status) &&
        Objects.equals(this.deliveryType, recentDeliveryResponse.deliveryType) &&
        Objects.equals(this.merchantName, recentDeliveryResponse.merchantName) &&
        Objects.equals(this.createdDate, recentDeliveryResponse.createdDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(deliveryId, hubTrackingNumber, status, deliveryType, merchantName, createdDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RecentDeliveryResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RecentDeliveryResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RecentDeliveryResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecentDeliveryResponse is not found in the empty JSON string", RecentDeliveryResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RecentDeliveryResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RecentDeliveryResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecentDeliveryResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecentDeliveryResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecentDeliveryResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecentDeliveryResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<RecentDeliveryResponse>() {
           @Override
           public void write(JsonWriter out, RecentDeliveryResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RecentDeliveryResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RecentDeliveryResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RecentDeliveryResponse
   * @throws IOException if the JSON string is invalid with respect to RecentDeliveryResponse
   */
  public static RecentDeliveryResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecentDeliveryResponse.class);
  }

  /**
   * Convert an instance of RecentDeliveryResponse to an JSON string
   *
   * @return JSON string
   */
